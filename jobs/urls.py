...
urlpatterns = [
    ...
    url(r'^addre/(?P<vmtype>.*)/$', views.add, name='jobsaddre'),
    url(r'^add/files/$', views.addfiles, name='jobsaddfiles'),
    url(r'^add/proxmox/$', views.addproxmox, name='jobsaddproxmox'),
    url(r'^add/xenserver/$', views.addxenserver, name='jobsaddxen'),
    url(r'^add/kvm/$', views.addkvm, name='jobsaddkvm'),
    url(r'^add/vmware/$', views.addvmware, name='jobsaddvmware'),
    ...
    url(r'^edit/xenserver/(?P<name>.*)/$', views.editxenserver, name='jobseditxenserver'),
    url(r'^edit/kvm/(?P<name>.*)/$', views.editkvm, name='jobseditkvm'),
    url(r'^edit/vmware/(?P<name>.*)/$', views.editvmware, name='jobseditvmware'),
    ...
    url(r'^advanced/xenserver/(?P<name>.*)/$', views.xenserveradvanced, name='jobsxenserveradvanced'),
    url(r'^advanced/kvm/(?P<name>.*)/$', views.kvmadvanced, name='jobskvmadvanced'),
    url(r'^advanced/vmware/(?P<name>.*)/$', views.vmwareadvanced, name='jobsvmwareadvanced'),
