...
$(function () {
  ...
  $('#{{ form.localrestore.id_for_label }}').on('ifChanged', function(e) {
    ...
    if (isChecked){
      ...
      $('#{{ form.proxmoxstorage.id_for_label }}-group').hide();
      $('#{{ form.proxmoxpool.id_for_label }}-group').hide();
    } else {
      $('#{{ form.where.id_for_label }}-group').hide();
      $('#{{ form.replace.id_for_label }}-group').hide();
      $('#{{ form.proxmoxstorage.id_for_label }}-group').show();
      $('#{{ form.proxmoxpool.id_for_label }}-group').show();
    };
  });
...
{% include 'widgets/helpbutton.js' with helppage='restore.jobidproxmox' %}
