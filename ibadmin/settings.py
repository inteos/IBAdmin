"""
Django settings for ibadmin project.
...
SECRET_KEY = 'z+d$5ie=e28ov=d+iftgl*!y6!85qgi0xm46&lvw$t^p934$t5'
...
WSGI_APPLICATION = 'ibadmin.wsgi.application'
